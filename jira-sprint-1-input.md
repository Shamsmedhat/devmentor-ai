# Sprint 1 Task — Input Component (All Variants)

Project: KAN · Sprint: Sprint 1 (KAN Sprint 1) · Epic: Design System & Components · Priority: High · Story points: 5

When a student asks how to build the Input component task, what its variants are, when it is accepted, or which sprint it belongs to — answer from this document. This is an Elevate Tech bootcamp task.
...
## Acceptance criteria (the task is accepted when ALL of these pass)
...
Design reference: https://www.figma.com/design/q5TO5u0kOpfIZhoozTz0mB/Rose-App--Enhanced-?node-id=16745-10693
