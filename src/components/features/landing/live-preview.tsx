        ...
        <div className="relative mx-auto mt-16 max-w-5xl lg:mt-20">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-card shadow-[0_30px_80px_rgba(0,0,0,0.6)]">
            ...
            <div className="relative flex min-h-[360px] flex-col gap-4 p-6 sm:min-h-[420px] sm:p-10">
              ...
              <div className="me-auto max-w-[85%] rounded-2xl rounded-ss-sm border border-chart-2/25 bg-chart-2/5 px-4 py-3 text-sm leading-relaxed text-foreground/90 sm:text-[15px]">
                {t("preview-chat-ai")}
              </div>
          ...
          <div className="mt-10 flex justify-center">
            <Button
              asChild
              size="lg"
              className="h-12 rounded-xl border border-chart-2/50 bg-chart-2/10 px-8 text-sm font-semibold text-chart-2 shadow-[0_0_30px_rgba(0,212,255,0.2)] hover:border-chart-2 hover:bg-chart-2/20"
            >
